...
// --- ШАГ 2: НОВАЯ ФУНКЦИЯ ДЛЯ СОЗДАНИЯ КРАСИВОГО HTML ---
// Эта функция берет данные от ИИ и вставляет их в профессиональный шаблон
...
export default async function handler(request, response) {
    ...
    try {
        // --- ШАГ 1: НОВЫЙ, МОЩНЫЙ ПРОМПТ ДЛЯ OPENAI ---
        ...
        // --- Шаг 2: Генерация PDF с помощью PDFshift ---
